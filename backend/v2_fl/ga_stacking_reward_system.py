...
class GAStackingRewardSystem:
    ...
    def start_training_round(self, round_number):
        ...
        # Reward amount increases with round number to encourage sustained participation
        reward_amount = base_amount + (round_number - 1) * increment
        
        # Fund the reward pool
        try:
            # Use blockchain connector's method to fund the reward pool
    ...
    def finalize_round_and_allocate_rewards(self, round_number):
        ...
        """
        try:
            # First finalize the reward pool
            ...
            if tx_hash:
                ...
                allocated_eth = pool_info['allocated_eth']
    ...
    def get_reward_pool_info(self, round_number):
        ...
        """
        try:
            if hasattr(self.blockchain, 'get_round_reward_pool'):
                # Use blockchain connector's method if available
