...
# Simple model definition (same as in server.py)
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        avg_loss = train_loss / examples if examples > 0 else 0
        return self.get_parameters({}), examples, {"loss": avg_loss}
    ...
    def evaluate(self, parameters, config):
        ...
        avg_loss = loss / examples if examples > 0 else 0
        return loss, examples, {"loss": avg_loss}
